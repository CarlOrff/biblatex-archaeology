...
%%% Bibliography
\usepackage[style=rgk-inline,date=iso]{biblatex}
...
@MISC{intro:date:1,date={1980}}
@MISC{intro:date:2,date={1980/1992}}
@MISC{intro:date:3,date={1980/}}
@MISC{intro:date:4,date={/1992}}
@MISC{intro:date:5,date={1980/..}}
@MISC{intro:date:6,date={../1992}}
@MISC{intro:date:7,date={1908-01}}
@MISC{intro:date:8,date={1980-01-31}}
@MISC{intro:date:9,date={1980-01-31/1992-03}}
@MISC{intro:date:10,date={1980-01-31T09:30:00}}
@MISC{intro:date:11,date={1980-01-31T09:30:00/1992-03}}
@MISC{intro:date:12,date={0000}}
@MISC{intro:date:13,date={-0332}}
@MISC{intro:date:14,date={-0332/-0331}}
@MISC{intro:date:15,date={0571}}
@MISC{intro:date:16,date={-0332/-0331-02}}
@MISC{intro:date:17,date={-0332-11-28/-0331-02}}
@MISC{intro:date:18,date={1980~}}
@MISC{intro:date:19,date={1980?}}
@MISC{intro:date:20,date={1980%}}
@MISC{intro:date:21,date={1980-01-XX}}
@MISC{intro:date:22,date={1980-XX-XX/1992-XX-XX}}
@MISC{intro:date:23,date={1980-24}}
...
\newcommand{\DatumDemo}[1]{\citefield{#1}[userd]{userd} & \citedate{#1}\\}
...
\begin{xltabular}{\linewidth}{p{\ErsteSpalte}LL}
\rowcolor{zebraodd}
...
\Typ{booklet} & wie \Typ{book}, aber ohne Verlag & \Feld{authtor}/\Feld{editor}, \Feld{title}, \Feld{date} \\
...
\Typ{manual} & Handbücher bzw. Dokumentationen für Geräte, Software, Laborausstattung etc. & \Feld{authtor}/\Feld{editor}, \Feld{title}, \Feld{date} \\
\Typ{misc} & wenn nichts anderes paßt & \Feld{authtor}/\Feld{editor}, \Feld{title}, \Feld{date} \\
\Typ{online} & Onlineressourcen & \Feld{authtor}/\Feld{editor}, \Feld{title}, \Feld{date}, \Feld{url} \\
...
\Typ{unpublished} & unpubliziert & \Feld{authtor}/\Feld{editor}, \Feld{title}, \Feld{date} \\
...
\item Mit \Kbd{book<feld>} werden Feldnamen von Sammelwerken in unselbstständigen Typen gebildet, weil die Felder ohne Präfix dort schon besetzt sind: \Feld{bookauthor}, \Feld{bookauthortype}, \Feld{booktitle}, \Feld{booksubtitle}, \Feld{booktitleaddon}, \Feld{bookpagination}.
...
Die folgende Tabelle enthält die Datenfelder, also solche, die von den Stilen für die jeweiligen Dokumententypen über das Datenmodell unterstützt werden können (oder auch nicht).
...
\Feld{author} & Name & Autor(-en) \\
\Feld{authortype} & Lokalisation & Rolle des Autors \\
\Feld{bookauthor} & Name & Autor(-en) von Sammelwerken \\
\Feld{bookpagination} & Lokalisation & Art der Seitenzählung (Paragraphen, Spalten etc.) \\
\Feld{booksubtitle} & Text & Untertitel eines Sammelwerks \\
\Feld{booktitle} & Text & Titel eines Sammelwerks \\
\Feld{booktitleaddon} & Text & Titelzusatz eines Sammelwerks \\
...
\Feld{date} & Datum & Publikationsdatum \\
\Feld{doi} & wörtlich & \Englisch{Digtal Object Identifier} (DOI) \\
\Feld{edition} & Ganzzahl oder Text & Auflage \\
\Feld{editor} & Name & Herausgeber \\
...
\Feld{entrysubtype} & Text & Spezifizierer des Dokumententyps \\
\Feld{eprint} & wörtlich & ID eines elektronischen Dokuments \\
...
\Feld{eventdate} & Datum & Veranstaltungsdatum \\
...
\Feld{howpublished} & Text & nähere Information zu ungewöhnlichen Publiukationsformen \\
\Feld{indextitle} & Text & wenn der Titel in abweichender Form im Index erscheinen soll (z.\,B. ohne führenden Artikel) \\
\Feld{institution} & Liste & Name der Institution bei Hochschulschriften \\
...
\Feld{journalsubtitle} & Text & Untertitel einer Zeitschrift \\
\Feld{journaltitle} & Text & Titel einer Zeitschrift \\
\Feld{label} & Text & Zitatlabel, (wenn die automatisch erzeugten nicht erwünscht sind) \\
\Feld{language} & Schlüsselliste & Sprache des Eintrags \\
\Feld{library} & Text & Angaben zu Standorten des Werks \\
\Feld{location} & Liste & Publikationsort \\
\Feld{mainsubtitle} & Text & Hauptuntertitel eines mehrbändigen Werks \\
\Feld{maintitle} & Text & Haupttitel eines mehrbändigen Werks \\
\Feld{maintitleaddon} & Text & Haupttitelzusatz eines mehrbändigen Werks \\
...
\Feld{number} & Text & Nummer eines Zeitschriftenheftes oder einer Serie \\
\Feld{organization} & Liste & Institution, die ein Werk publiziert hat  \\
\Feld{origdate} & Datum & Originaldatum bei Nachdrucken oder Übersetzungen \\
\Feld{origlanguage} & Schlüsselliste & Originalsprache bei Nachdrucken oder Übersetzungen \\
\Feld{origlocation}  & Liste & originale Publikationsorte bei Nachdrucken oder Übersetzungen \\
\Feld{origpublisher} & Liste & Originalverlage bei Nachdrucken oder Übersetzungen \\
\Feld{origtitle} & Text & Originaltitel bei Nachdrucken oder Übersetzungen \\
\Feld{pages} & Zahlenbereich & Seitenzahlen bei unselbstständigen Publikationen \\
\Feld{pagetotal} & Text & Gesamtzahl der Seiten eines selsbtständigen Werks \\
\Feld{pagination} & Lokalisation & Art der Seitenzählung (Paragraphen, Spalten etc.) \\
\Feld{part} & Text & Teil bzw. Faszikel eines mehrbändigen Werkes (nicht bei Zeitschriften!)\\
\Feld{publisher} & Liste & Verlag \\
\Feld{pubstate} & Lokalisation & Publikationsstatus (z.\,B. \enquote{im Druck}) \\
\Feld{reprinttitle} & Text & Titel eines Reprints \\
\Feld{series} & Text & Serientitel bei Büchern als auch Zeitschriften (z.\,B. \enquote{Neue Folge}) \\
\Feld{shortauthor} & Name & Abkürzung des \Feld{author}, v.\,a. bei korporativen Autoren \\
\Feld{shorteditor} & Name & Abkürzung des \Feld{editor}, v.\,a. bei korporativen Herausgebern \\
...
\Feld{shortjournal} & Text & Abkürzung des Zeitschriftentitels \\
\Feld{shortseries} & Text & Abkürzung des Serientitels \\
\Feld{shorttitle} & Text & Abkürzung des Titels \\
\Feld{subtitle} & Text & Untertitel \\
\Feld{title} & Text & Titel \\
\Feld{titleaddon} & Text & Titelzusatz \\
\Feld{translator} & Name & Übersetzer \\
\Feld{type} & Lokalisation & Art des Dokuments bei \Typ{manual}, \Typ{patent}, \Typ{report} und \Typ{thesis} \\
\Feld{url} & wörtlich & URL \\
\Feld{urldate} & Datum & Zugriffsdatum eines Onlinedokuments \\
\Feld{venue} & Text & Veranstaltungsort \\
\Feld{version} & Text & Versionsnummer \\
\Feld{volume} & Ganzzahl & Bandnummer sdowohl bei mehrbändigen Werken als auch Zeitschriften \\
...
Wenn man mehrere Werke an derselben Stelle zitieren will, kann man eine kommaseparierte Liste von Lokalisationn übergeben: \SaveVerb{Verb}|\cite{steinmetz:strahl:wilbers:1979,cossel:1933-35,ib:domino:europa}|\Beispiel{\cite{steinmetz:strahl:wilbers:1979,cossel:1933-35,ib:domino:europa}}
