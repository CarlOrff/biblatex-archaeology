...
\makeatother
\newrobustcmd*{\Befehl}[1]{\texttt{\textbackslash#1}\index{Kommando (TeX)!\textbackslash#1}}
\newrobustcmd*{\Typ}[1]{\texttt{\symbol{64}#1}\index{Dokumententyp!#1}}
% no hyphenation within tt fonts:
\newrobustcmd*{\Paket}[1]{\textsf{#1}\index{Paket (\TeX)!\textsf{#1}}}
\newrobustcmd*{\App}[1]{\textsf{#1}\index{Paket (kein \TeX)!\textsf{#1}}}
\newrobustcmd*{\Feld}[1]{\texttt{#1}\index{Feld (TeX)!\texttt{#1}}}
\newrobustcmd*{\Option}[1]{\texttt{\detokenize{#1}}\index{Option!placeholder}}
\newrobustcmd*{\Umgebung}[1]{\texttt{#1}\index{Umgebung!\texttt{#1}}}
\newrobustcmd*{\Lokalisierung}[1]{\texttt{#1}\index{Lokalisierung!\texttt{#1}}}
\newrobustcmd*{\Kbd}[1]{\texttt{#1}}
\newrobustcmd*{\Stil}[1]{\texttt{#1}\index{Stil!\texttt{#1}}}
\newrobustcmd*{\Datei}[1]{\texttt{\detokenize{#1}}\index{Datei!placeholder}}
