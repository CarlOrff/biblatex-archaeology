...
% \begin{environment}{leftmarginbibliography}
% Sets labels into an extra column.
%    \begin{macrocode}
\defbibenvironment{leftmarginbibliography}
    {\list
        {\printtext[labelnamedatewidth]{%
            \begingroup\parbox[t]{\labelnamedatewidth}{\raggedright\usebibmacro{repeatlabel}}\endgroup}}
    ...
    {\endlist}
    {\item\renewbibmacro{repeatlabel}{}\renewcommand*{\repeatlabeldelim}{}}%
%    \end{macrocode}
% \end{environment}
