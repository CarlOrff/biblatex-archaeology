...
\usepackage[english,latin,french,dutch,danish,german,ngerman]{babel}
%\usepackage[latin,french,dutch,danish,ngerman,german,english]{babel}
...
\IfFileExists{ingram-braun-locals.sty}
