...
\ifdefined\HCode% detect tex4ht
    ...
    \usepackage[USenglish,nswissgerman,german,british]{babel}
    \usepackage{lmodern}
...
\else 
	\usepackage{fontspec}
	%\usepackage[T1]{fontenc}
	\usepackage{noto}%\setmonofont{NotoSansMono}[HyphenChar=None]
...
\begin{enumerate}
	...
	\item[\footnotesize\Befehl{volcite}] \volcite{1}[156]{linnaeus:2003}
	\item[\footnotesize\Befehl{avolcite}] \avolcite{1}[156]{linnaeus:2003}
	\item[\footnotesize\Befehl{fvolcite}] \fvolcite{1}[156]{linnaeus:2003}
	\item[\footnotesize\Befehl{pvolcite}] \pvolcite{1}[156]{linnaeus:2003}
	\item[\footnotesize\Befehl{svolcite}] \svolcite{1}[156]{linnaeus:2003}
	\item[\footnotesize\Befehl{tvolcite}] \tvolcite{1}[156]{linnaeus:2003}
	\item[\footnotesize\Befehl{Volcite}] \Volcite{2}[34--36]{van:der:linde:1874}
	\item[\footnotesize\Befehl{Avolcite}] \Avolcite{2}[34--36]{van:der:linde:1874}
	\item[\footnotesize\Befehl{Pvolcite}] \Pvolcite{2}[34--36]{van:der:linde:1874}
	\item[\footnotesize\Befehl{Svolcite}] \Svolcite{2}[34--36]{van:der:linde:1874}
	\item[\footnotesize\Befehl{Tvolcite}] \Tvolcite{2}[34--36]{van:der:linde:1874}
	\item[\footnotesize\Befehl{volcites}] \volcites{2}[34--36]{van:der:linde:1874}{1}[156]{linnaeus:2003}
	\item[\footnotesize\Befehl{avolcites}] \avolcites{2}[34--36]{van:der:linde:1874}{1}[156]{linnaeus:2003}
	\item[\footnotesize\Befehl{fvolcites}] \fvolcites{2}[34--36]{van:der:linde:1874}{1}[156]{linnaeus:2003}
	\item[\footnotesize\Befehl{pvolcites}] \pvolcites{2}[34--36]{van:der:linde:1874}{1}[156]{linnaeus:2003}
	\item[\footnotesize\Befehl{svolcites}] \svolcites{2}[34--36]{van:der:linde:1874}{1}[156]{linnaeus:2003}
	\item[\footnotesize\Befehl{tvolcites}] \tvolcites{2}[34--36]{van:der:linde:1874}{1}[156]{linnaeus:2003}
	\item[\footnotesize\Befehl{Volcites}] \Volcites{2}[34--36]{van:der:linde:1874}{1}[156]{linnaeus:2003}
	\item[\footnotesize\Befehl{Avolcites}] \Avolcites{2}[34--36]{van:der:linde:1874}{1}[156]{linnaeus:2003}
	\item[\footnotesize\Befehl{Pvolcites}] \Pvolcites{2}[34--36]{van:der:linde:1874}{1}[156]{linnaeus:2003}
	\item[\footnotesize\Befehl{Svolcites}] \Svolcites{2}[34--36]{van:der:linde:1874}{1}[156]{linnaeus:2003}
	\item[\footnotesize\Befehl{Tvolcites}] \Tvolcites{2}[34--36]{van:der:linde:1874}{1}[156]{linnaeus:2003}
    ...
    \item[\footnotesize\Befehl{Posscites}] \ifcsdef{Posscites}
        {\Posscites[48]{auler:hiller:2015a}[19]{de:neck:yoder:1978}[123]{buss:2004}{nass:1938}{caselitz:1980a}[187--190]{molleson:cox:1993}[11--12]{steinmetz:strahl:wilbers:1979}{domino:1780}}
        {\textbf{undefined!}}%
	\item[\footnotesize\Befehl{possvolcite}] \ifcsdef{possvolcite}
        {\possvolcite{2}[34--36]{van:der:linde:1874}}
        {\textbf{undefined!}}%
    \item[\footnotesize\Befehl{possvolcites}] \ifcsdef{possvolcites}
	...
	\item[\footnotesize\Befehl{textreviewcites}] \ifcsdef{textreviewcites}
        {\textreviewcites{de:neck:yoder:1978}[123]{buss:2004}{nass:1938}[123]{sterk:1777}[187--190]{molleson:cox:1993}[11--12]{steinmetz:strahl:wilbers:1979}{domino:1780}}
        {\textbf{undefined!}}%
	\item[\footnotesize\Befehl{Reviewcites}] \ifcsdef{Reviewcites}
	...
	\item[\footnotesize\Befehl{Previewcites}] \ifcsdef{Previewcites}
        ...
        {\textbf{undefined!}}%
	\item[\footnotesize\Befehl{Textreviewcites}] \ifcsdef{Textreviewcites}
        {\Textreviewcites{de:neck:yoder:1978}[123]{sterk:1777}{nass:1938}[123]{sterk:1777}[187--190]{molleson:cox:1993}[11--12]{steinmetz:strahl:wilbers:1979}{domino:1780}}
        {\textbf{undefined!}}%
\end{enumerate}
