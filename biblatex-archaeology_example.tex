...
%    \end{macrocode}
% Move plan BibTeX \Feld{years} to \Feld{date} field if the latter not available (only 4-dgit years)
%    \begin{macrocode}
		\map{
            \step[ 
                fieldsource=year,
                fieldset=date,
				match=\regexp{\A\d{4}\Z},
				origfieldval,
				notfield=date,
				final
            ]
...
%    \end{macrocode}
% Move \Feld{address} to \Feld{location} if the latter not existent.
%    \begin{macrocode}
		\map{
             \step[
                fieldsource=address,
