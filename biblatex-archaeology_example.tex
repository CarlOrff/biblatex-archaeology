...
\newtoggle{archbool:posscite}
\togglefalse{archbool:posscite}


\renewbibmacro*{genitive}[1]{AAA%
	\ifboolexpr{
		test {\ifdefvoid{#1}}
		or
		togl {archbool:posscite}
	}
        {\global\togglefalse{archbool:posscite}}
        {\togglefalse{archbool:genitiveapostrophe}%
		 \global\toggletrue{archbool:posscite}%
         \fullexpandarg%
...
%    \item[\footnotesize\Befehl{Smartcite}] \smartcite[159--187]{auler:hiller:2015}
	...
	\item[\footnotesize\Befehl{mautocite}] \ifcsdef{mautocite}
        {\mautocite[48]{de:neck:yoder:1978}}
        {\textbf{undefined!}}%
	\item[\footnotesize\Befehl{Mautocite}] \ifcsdef{Mautocite}
        {\Mautocite[48]{de:neck:yoder:1978}}
        {\textbf{undefined!}}%
