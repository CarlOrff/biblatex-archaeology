...
\else 
    ...
    \setmonofont{NotoSansMono}[HyphenChar=None]
...
\DeclareCiteCommand{\textreviewcite}[]
	{\blxarch@reviewcite@removefields\usebibmacro{prenote}}
	{\usedriver
      {\ifboolexpr{
		  ...
		  {\ifciteindex
			...
			{}%
		  \DeclareNameAlias{sortname}{gfull-family}%
		  \printnames{labelname}%
		  \DeclareNameFormat{\thefield{labelnamefield}}{}%
		  \ifboolexpr{
			test {\ifnameundef{author}}
			or
			not test {\iffieldundef{authortype}}
		  }
			{\DeclareDelimAlias{nametitledelim}{\addspace}}
			{\DeclareDelimAlias{nametitledelim}{}}%
		  \DeclareDelimAlias{authortypedelim}{}%
		  \DeclareDelimAlias{editortypedelim}{}%
		  \DeclareDelimAlias{translatortypedelim}{}%
		  \addspace}
		  {\DeclareDelimAlias{nametitledelim}{}}%
	  \bibopenparen}
      {\thefield{entrytype}}}%
