...
\DeclareNameAlias{shortformauthor}{given-family}
\DeclareFieldFormat*{shortformauthor}{\addspace\mkbibparens{#1}}

% \begin{macro}{\sfcite}
% \begin{macro}{\sfcites}
% Make it a \Befehl{cite} alias in author date styles! Originally planned as starred variant.
% but the \Befehl{DeclareMultiCiteCommand} did not accept it.
%    \begin{macrocode}
\DeclareCiteCommand{\sfcite}[]
  ...
  \ifnameundef{author}{}
  {\printtext[shortformauthor]{\printnames[shortformauthor]{author}}}%
}
...
% \end{macro}
%
% \begin{macro}{\shortformcite}
% \begin{macro}{\shortformcites}
% Make it an \Befehl{autocite} alias in author date styles!
%    \begin{macrocode}
