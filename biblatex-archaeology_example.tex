...
\begin{enumerate}
    ...
    \item[\footnotesize\Befehl{shortformcite}] \ifblxarch
        {\shortformcite[433]{bauchhenss:et:al:1978}}
        {\textbf{undefined!}}%
    \item[\footnotesize\Befehl{shortformcites}] \ifblxarch
        {\shortformcites[433]{bauchhenss:et:al:1978}[501]{authen-blom:1989}}
        {\textbf{undefined!}}%
    \item[\footnotesize\Befehl{sfcite}] \ifblxarch
        {\sfcite[433]{bauchhenss:et:al:1978}}
        {\textbf{undefined!}}%
    \item[\footnotesize\Befehl{sfcites}] \ifblxarch
        {\sfcites[433]{bauchhenss:et:al:1978}[501]{authen-blom:1989}}
        {\textbf{undefined!}}%
    \item[\footnotesize\Befehl{posscite}] \ifblxarch
        {\posscite[48]{auler:hiller:2015a}}
        {\textbf{undefined!}}%
    \item[\footnotesize\Befehl{posscites}] \ifblxarch
    ...
    \item[\footnotesize\Befehl{Posscites}] \ifblxarch
        {\Posscites[48]{auler:hiller:2015a}[19]{de:neck:yoder:1978}[123]{buss:2004}{nass:1938}{caselitz:1980a}[187--190]{molleson:cox:1993}[11--12]{steinmetz:strahl:wilbers:1979}{domino:1780}}
        {\textbf{undefined!}}%
	\item[\footnotesize\Befehl{possvolcite}] \ifblxarch
        {\possvolcite{2}[34--36]{van:der:linde:1874}}
        {\textbf{undefined!}}%
    \item[\footnotesize\Befehl{possvolcites}] \ifblxarch
    ...
    \item[\footnotesize\Befehl{Possvolcites}] \ifblxarch
        {\Possvolcites{2}[34--36]{van:der:linde:1874}{1}[156]{linnaeus:2003}}
        {\textbf{undefined!}}%
	\item[\footnotesize\Befehl{citeissue}] \ifblxarch
        {\citeissue[48]{bericht:rgk:1988}}
        {\textbf{undefined!}}%
	\item[\footnotesize\Befehl{fciteissue}] \ifblxarch
        {\fciteissue[48]{bericht:rgk:1988}}
        {\textbf{undefined!}}%
	\item[\footnotesize\Befehl{pciteissue}] \ifblxarch
        {\pciteissue[48]{bericht:rgk:1988}}
        {\textbf{undefined!}}%
	\item[\footnotesize\Befehl{citeissues}] \ifblxarch
        {\citeissues[48]{bericht:rgk:1988}}
        {\textbf{undefined!}}%
	\item[\footnotesize\Befehl{fciteissues}] \ifblxarch
        {\fciteissues[48]{bericht:rgk:1988}}
        {\textbf{undefined!}}%
	\item[\footnotesize\Befehl{pciteissues}] \ifblxarch
        {\pciteissues[48]{bericht:rgk:1988}}
        {\textbf{undefined!}}%
	\item[\footnotesize\Befehl{reviewcite}] \ifblxarch
        {\reviewcite[19]{de:neck:yoder:1978}}
        {\textbf{undefined!}}%
	\item[\footnotesize\Befehl{previewcite}] \ifblxarch
        {\previewcite[48]{auler:hiller:2015a}}
        {\textbf{undefined!}}%
	\item[\footnotesize\Befehl{textreviewcite}] \ifblxarch
	...
	\item[\footnotesize\Befehl{Textreviewcite}] \ifblxarch
        ...
        {\textbf{undefined!}}%
	\item[\footnotesize\Befehl{reviewcites}] \ifblxarch
        ...
        {\textbf{undefined!}}%
	\item[\footnotesize\Befehl{previewcites}] \ifblxarch
        ...
        {\textbf{undefined!}}%
	\item[\footnotesize\Befehl{textreviewcites}] \ifblxarch
...
\ifblxarch{\printbibliography[env=leftmarginbibliography,title={Verzeichnis im alten RGK-Stil}]}{}
